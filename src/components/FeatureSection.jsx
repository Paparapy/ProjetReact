  ...
  return (
    <div className="relative min-h-screen mt-10 border-b border-neutral-800">
      <div className="text-center">
        ...
        <h2 className="mt-10 text-3xl font-semibold tracking-wide sm:text-3xl lg:text-6xl lg:mt-20">
      ...
      <div className="flex flex-wrap sm:mt-10 lg:mt-20">
        {features.map((feature, index) => (
          <div key={index} className="w-full p-4 sm:w-1/2 lg:w-1/3">
            <div className="feature-card cursor-pointer flex flex-col w-full p-4 h-[300px] border-2 border-orange-700 animated-border shadow-lg shadow-orange-500">
              <div className="flex items-center justify-center w-10 h-10 p-2 mx-auto mb-4 text-orange-700 rounded-full bg-neutral-900">
                {feature.icon}
              </div>
              <div className="text-center">
                <h5 className="mt-1 mb-4 text-xl font-semibold lg:text-[20px] sm:text-[15px]">
                  {feature.text}
                </h5>
